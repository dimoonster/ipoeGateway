<?php /* Smarty version Smarty-3.1.7, created on 2012-03-12 19:25:24
         compiled from "/opt/ipoev2/var/www/htdocs/cabinet/lib/../template/login_form.html" */ ?>
<?php /*%%SmartyHeaderCode:9722472914f3b960bc70d78-52403352%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7163edae7cb62be6b615bf4ba1a14f4368951e19' => 
    array (
      0 => '/opt/ipoev2/var/www/htdocs/cabinet/lib/../template/login_form.html',
      1 => 1328534797,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '9722472914f3b960bc70d78-52403352',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_4f3b960bec375',
  'variables' => 
  array (
    'TITLE' => 0,
    'BASE_URL' => 0,
...
<?php if ($_valid && !is_callable('content_4f3b960bec375')) {function content_4f3b960bec375($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
">
<?php if ($_smarty_tpl->tpl_vars['CHECK_AUTH_RESULT']->value==-1){?>
	<div class="lineAuthErr">Аутентификация не удалась!</div>
	<div class="clr"></div>
<?php }?>
	<div class="line"><label>Имя пользователя:</label><input type="text" name="login" value="<?php echo $_smarty_tpl->tpl_vars['LOGIN']->value;?>
" /></div>
	<div class="clr"></div>
	<div class="line"><label>Пароль:</label><input type="password" name="password" value="" /></div>
	<div class="clr"></div>
	<div class="lineSubmit"><input type="submit" value="Войти" /></div>
    </form>
</div>
